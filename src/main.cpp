...
uint256 hashGenesisBlock("0x6b6fca6704c55a77cc4bd5d167011564182cdd962dbf4d19ddef02785a301f7b");
...
const string strMessageMagic = "MarketCredits Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // MarketCredits: 1 days
static const int64 nTargetSpacing = 60; // MarketCredits: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal marketcredits miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MarketCredits", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "U.S. and Canadian Groups Come Together to Contest COOL Rule - AllAgNews 07.11.2013";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1373558902; //epochtime
        ...
        assert(block.hashMerkleRoot == uint256("0xe8e5faf6e3c14f95624cc2d57dbf7fc736da373149e4225882c4bb4bcfdb665b"));
